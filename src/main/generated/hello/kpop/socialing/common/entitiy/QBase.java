...
public class QBase extends EntityPathBase<Base> {
    ...
    private static final long serialVersionUID = 876770967L;

    public static final QBase base = new QBase("base");

    public final DateTimePath<java.time.LocalDateTime> mod_dt = createDateTime("mod_dt", java.time.LocalDateTime.class);
