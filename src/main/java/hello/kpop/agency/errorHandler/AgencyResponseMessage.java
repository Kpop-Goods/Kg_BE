...
public class AgencyResponseMessage {
    ...
    public static final String UNAUTHORIZED_AGENCY_REGISTER = "소속사 등록 실패, 권한이 없습니다.";
    ...
    public static final String UNAUTHORIZED_AGENCY_UPDATE = "소속사 수정 실패, 권한이 없습니다.";
    ...
    public static final String UNAUTHORIZED_AGENCY_DELETE = "소속사 삭제 실패, 권한이 없습니다.";
